 ...
 * generated in the com.atguigu.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Info_QNAME = new QName("http://webservice.atguigu.com/", "info");
    private final static QName _InfoResponse_QNAME = new QName("http://webservice.atguigu.com/", "infoResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.atguigu.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.atguigu.com/", name = "info")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.atguigu.com/", name = "infoResponse")
