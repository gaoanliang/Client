 ...
 * 2016-12-16T19:43:47.084+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:80/HelloWebService/services/HelloWorld?wsdl",
                  targetNamespace = "http://webservice.atguigu.com/") 
public class HelloWorldImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://webservice.atguigu.com/", "HelloWorldImplService");
    public final static QName HelloWorldImplPort = new QName("http://webservice.atguigu.com/", "HelloWorldImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:80/HelloWebService/services/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:80/HelloWebService/services/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
